...
//BOOL CEdgeBrowserAppApp::ProcessMessageFilter(int code, LPMSG pMsg)
//{
//	CEdgeBrowserAppDlg* dlg = (CEdgeBrowserAppDlg*)m_pMainWnd;
//	if (pMsg->wParam == VK_F6 /*pMsg->hwnd == m_pMainWnd->m_hWnd &&*/)
//	{
//		if (pMsg->message == WM_KEYDOWN)
//		{
//			if (!dlg->m_Focused /*dlg->GetFocus() == dlg->GetDlgItem(IDC_EDIT_URL)*/)
//			{
//				dlg->m_Focused = true;
//				dlg->GetWebViewController()->MoveFocus(COREWEBVIEW2_MOVE_FOCUS_REASON_PROGRAMMATIC);
//			}
//			//else
//			//	dlg->GotoDlgCtrl(dlg->GetDlgItem(IDC_EDIT_URL));
//		}
//		return TRUE;
//	}
